...
def main(
    ...
    control_frequency = config_dict["control_frequency"]
    controller_frequency = config_dict["controller_frequency"]
    single_arm_mode = config_dict["single_arm_mode"]
    no_state_obs_mode = config_dict["no_state_obs_mode"]
    steps_per_inference = config_dict["steps_per_inference"]
